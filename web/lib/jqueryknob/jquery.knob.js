// Modified to have perfect clickable multiknob
...
(function (factory) {
    ...
    k.o = function () {
        ...
        this.scrubbing = true; // the user is currently scrubbing the dial
        ...
        this.run = function () {
            ...
            this.o = $.extend({
                    ...
                    ,tickWidth : this.$.data('tickWidth') || 0.025
...
// scrubbing has started
        ...
        // propagate event to element underneath
         this._propagate = function(e)
 		{
 			...
 			s.$div.parent().css("pointer-events", "none");
 			if(e.type == "mousedown")
 			{
 			...
 			s.$div.parent().css("pointer-events", "auto");
 		}
